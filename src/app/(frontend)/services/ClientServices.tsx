  ...
  return (
    <div className="bg-black text-white selection:bg-white selection:text-black min-h-screen">
      ...
      <section className="px-6 md:px-16 lg:px-24 pt-20 md:pt-24 lg:pt-28 mb-12 relative overflow-hidden">
        ...
        <div className="max-w-[1800px] xl:max-w-[2200px] 2xl:max-w-[2400px] mx-auto relative z-10">
          <motion.div
          ...
          >
             <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[9.5vw] xl:text-[140px] 2xl:text-[180px] font-bold tracking-tighter uppercase leading-[0.85] flex flex-col">
               <span>FROM</span>
      ...
      <section className="px-6 md:px-12 lg:px-24 pb-20 md:pb-24 lg:pb-28">
        <div className="max-w-[1800px] xl:max-w-[2200px] 2xl:max-w-[2400px] mx-auto flex flex-col gap-6 md:gap-8">
