...
export default function ContactSection({ contactInfo = {} }: ContactSectionProps) {
  ...
  return (
    <section className="py-20 lg:py-28 relative overflow-hidden" id="contact">
      ...
      <div className="max-w-[1800px] 2xl:max-w-[2000px] mx-auto px-6 md:px-12 lg:px-24 relative z-10 flex flex-col lg:flex-row justify-between lg:items-stretch gap-16 lg:gap-8">
