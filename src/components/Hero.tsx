    ...
    <section className="relative min-h-[100dvh] w-full flex flex-col justify-end overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full flex flex-col justify-end pb-12 md:pb-16 lg:pb-24 pointer-events-none">
          ...
          >
            ...
            >
              <motion.span variants={item}>CREATING</motion.span>
              <motion.span variants={item} className="italic opacity-90">STORIES+</motion.span>
              <motion.span variants={item}>THAT MOVE</motion.span>
            </motion.h1>
            ...
            >
              <div className="flex gap-4 w-full md:w-auto">
                <button className="flex-1 md:flex-none rounded-full border border-white px-6 md:px-10 py-3 md:py-3.5 text-[10px] md:text-[12px] font-medium tracking-[0.15em] uppercase hover:bg-white hover:text-black transition-colors flex items-center justify-center gap-2 shrink-0 whitespace-nowrap text-white bg-transparent">
                  OUR SERVICES
