  ...
  return (
    <section className="py-20 md:py-24 lg:py-28 border-t border-white/10 bg-black relative z-10 text-center" id="about-us">
      <motion.div
        ...
        className="max-w-[1800px] xl:max-w-[2200px] 2xl:max-w-[2400px] mx-auto px-6 md:px-12 lg:px-24 flex flex-col items-center"
      >
        <div className="max-w-4xl flex flex-col items-center">
          ...
          <motion.h2 variants={item} className="text-4xl sm:text-5xl md:text-6xl lg:text-[76px] xl:text-[90px] 2xl:text-[120px] font-normal tracking-tighter leading-[0.95] mb-10 md:mb-14 uppercase whitespace-pre-wrap">
            {headline}
          </motion.h2>
