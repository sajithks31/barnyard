...
export default function Navbar({ data }: NavbarProps) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-[1800px] xl:max-w-[2400px] 2xl:max-w-[2800px] mx-auto px-6 md:px-16 lg:px-24 py-6 md:py-8 flex items-center justify-between pointer-events-auto">
          {/* Left: Logo Section */}
