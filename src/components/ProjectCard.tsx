  ...
  return (
    ...
    >
      <div className={`relative ${aspectClass} overflow-hidden bg-[#111] ring-1 ring-white/5 mx-auto w-full max-w-full`}>
        <img 
          src={project.image?.asset ? urlFor(project.image).width(1200).auto('format').url() : "https://images.unsplash.com/photo-1574719266848-692ab8d0ca28?q=80&w=1200&auto=format&fit=crop"} 
          alt={project.title}
          loading="lazy"
