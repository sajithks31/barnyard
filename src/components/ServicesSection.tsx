...
const ServiceCard = ({ 
  ...
  return (
    <div ref={container} className="h-[90vh] flex items-start justify-center sticky top-0 px-4 md:px-0">
      <motion.div 
        style={{ 
          scale, 
          opacity,
          zIndex: (idx + 1) * 10,
          top: `calc(2% + ${idx * 20}px)`
        }}
  ...
  return (
    <section ref={container} className="bg-background relative z-10" id="services">
      <div className="max-w-[1800px] xl:max-w-[2400px] 2xl:max-w-[2800px] px-6 md:px-12 lg:px-24 mx-auto pt-0 pb-32 lg:pb-[20vh]">
        <div className="mb-0 flex flex-col items-start text-left">
          <motion.span 
